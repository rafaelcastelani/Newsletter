...
class NewsLetterBamarangController extends BaseController {
	...
	public function generatehtmlAction(){
		...
		echo ($wdb->generateBamarangHtmlHeader($header_date));
		if(count($banner)){
			...
			foreach($banner as $block){
				...
				'banner.php',//$template,
				"",//$title = null,
				$wdb->getURLBAMA($block['url_campanha'],/*$block['type_code']*/"", $start_date,"IMG",$count),//$link1 = null,
				$wdb->getURLBAMA($block['url_campanha'],/*$block['type_code']*/"", $start_date,"BT",$count),//$link2 = null,
				"",//$alt = null,
		...
		if(count($novas)){
			...
			foreach($novas as $k=>$block){
				if($i < $qtdDestaque){
					...
					"",//$title = null,
					$wdb->getURLBAMA($block['url_campanha'],/*$block['type_code']*/"", $data,"IMG",$count),//$link1 = null,
					$wdb->getURLBAMA($block['url_campanha'],/*$block['type_code']*/"", $data,"BT",$count),//$link2 = null,
					"",//$alt = null,
					...
					"",//$title = null,
					$wdb->getURLBAMA($block['url_campanha'],"", $data,"IMG",$count),//$link1 = null,
					$wdb->getURLBAMA($block['url_campanha'],"", $data,"BT",$count),//$link2 = null,
					"",//$alt = null,
					"http://n.westwing.com.br/images/4370/".trim($block['url_proxima']),//$src = null,
					$block['name_campanha'],//$name = null,
					$block['subline'],//$desc = null,
		...
		if(count($revista)){
			foreach($revista as $block){
				...
				"",//$title = null,
				$wdb->getURLBAMA($block['url_campanha'],"", $start_date,"IMG",$count),//$link1 = null,
				$wdb->getURLBAMA($block['url_campanha'],"", $start_date,"TXT",$count),//$link2 = null,
				"",//$alt = null,
				"http://n.westwing.com.br/images/4370/".trim($block['url_proxima']),//$src = null,
				$block['name_campanha'],//$name = null,
				$block['subline'],//$desc = null,
